...
def process_maven_data(csv_file_path):
    ...
    filtered_df_G.to_csv('G.tsv', sep='\t', index=False)
    ...
    filtered_df_GA.to_csv('GA.tsv', sep='\t', index=False)

    return filtered_df_G, filtered_df_GA

# Run the function with the path to the CSV file
csv_file_path = "/content/drive/MyDrive/maven/2018dataset.csv"
filtered_df_G, filtered_df_GA = process_maven_data(csv_file_path)